...
> Grok-facing orientation; **complements** the backend's agent-facing `US`
...
Anthropic `Grok-for-legal` (litigation-legal for demands/claim-charts/dockets;
ip-legal; privacy-legal) for generic US drafting playbooks; `master-Grok-for-legal`
