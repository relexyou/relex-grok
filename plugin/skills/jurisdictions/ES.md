...
> Grok-facing orientation; complements the backend `ES` module. Pair with
...
**`betobetico/Grok-para-abogados`** (Spanish adaptation — 20 modules);
`robinlawyer/Grok-for-spanish-law` (BOE/CENDOJ/TC/TJUE/AEPD, early)
