...
The humans on the case see a collapsed "Grok steering session" marker with
your user's role and "via Grok" attribution; they can expand it read-only.
...
thread, attributed to your user "via Grok". Future agent turns read it
