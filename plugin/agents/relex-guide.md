---
name: relex-guide
description: Onboards a new Relex user — signs Grok in over OAuth, then walks through setting up the practice workflow (PII password, knowledge, auto-created encrypted parties) and a first case. PII-safe, deep-link first. Use when a user is new to Relex or asks how to get started or to "set up my practice workflow".
---
